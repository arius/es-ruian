...
module EsRuian
  class Parcel
    ...
    # http://ruian.eurosignal.cz/api/parcels/by_code/107611508
    ...
    # http://ruian.eurosignal.cz/api/search/by_circle/50.2399336/16.5188739/1000?kind=parcel
    ...
    # http://ruian.eurosignal.cz/api/parcels/by_cadastral_area_and_parcel_number/600083/1
